class Bullet extends Phaser.Physics.Arcade.Image {
    ...
    calculatePlayerVelocityRelativeToMouse() {
        ...
        const angleToMouse = Phaser.Math.Angle.Between(this.source.x, this.source.y, this.scene.input.activePointer.x, this.scene.input.activePointer.y); // calculates the angle between the player and the mouse
